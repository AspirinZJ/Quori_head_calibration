...
void sphereToimage(float R, double theta, double psi, double H, double W, double *px,
                   double *py, double dx, double dy)
{
    ...
    sphereToplane(0.52359877559829882, 3.1415926535897931, R, 1.5, 2.0, 1.0,
                  0.059068559067049511, 8.4476252817457738, &xp1, &yp1);
    sphereToplane(1.5707963267948966, 2.0943951023931953, R, 1.5, 2.0, 1.0,
                  0.059068559067049511, 8.4476252817457738, &ax, &ay);
    sphereToplane(theta, psi, R, 1.5, 2.0, 1.0, 0.059068559067049511,
